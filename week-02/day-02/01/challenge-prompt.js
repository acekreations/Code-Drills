...
var total = rentCost + utilitiesCost + foodCost + transportationCost + computerCost;
if (total < budget) {
  console.log("You are under budget: " + total);
}
else if (total > budget) {
  alert("Total costs:" + total + " - Budget: " + budget);
}
