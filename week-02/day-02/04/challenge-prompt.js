...
function warble(text) {
  var newText = text + "arglebargle";
  return newText;
}
...
function danceParty(string) {
  ...
  var text1 = wibble(string);

  var text2 = warble(string);

  var wibbleWarble = text1 + text2;
