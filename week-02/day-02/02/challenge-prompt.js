...
var numArrayTotal = 0;
for (var i = 0; i < numArray.length; i++) {
  numArrayTotal += numArray[i];
}
console.log(numArrayTotal);
...
for (var i = 0; i < fruits.length; i++) {
  if (uniqueFruits.indexOf(fruits[i]) < 0) {
...
for (var i = 0; i < twoDimArray.length; i++) {
  for (var j = 0; j < twoDimArray[i].length; j++) {
    var checkOdd = twoDimArray[i][j] % 2;
    if (checkOdd === 1) {
...
for (var i = 0; i < twoDimArray.length; i++) {
  for (var j = 0; j < twoDimArray[i].length; j++) {
    var checkMultipleThree = twoDimArray[i][j] % 3;
    if (checkMultipleThree === 0) {
