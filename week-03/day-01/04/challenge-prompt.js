...
var four = setTimeout(log("Hello"), 1000 * 17);
...
var five = setTimeout(log("Goodbye"), 1000 * 17);
...
setTimeout(removeTimer(five), 1000 * 5);
...
var removePartOne = setTimeout(function(){
  removeTimer(questionFour);
  console.log("Part 2");
}, 1000 * 2);
