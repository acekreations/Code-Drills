...
$(document).ready(function() {
	...
	/*///////////// HEROES ACTIVITY ///////////////////*/
      ...
      for (var i = 0; i < response.length; i++) {
        ...
        var header = $("<div>").addClass("header").html("<h2>" + response[i].squadName + "</h2>");
       ...
       var characters = $("<div>").addClass("characters");
        ...
        for (var j = 0; j < response[i].members.length; j++) {
          ...
          var image = $("<img>").addClass("hero-image").attr("src", response[i].members[j].image);
          ...
          var name = $("<p>").text(response[i].members[j].name);
				  ...
				  */
          var powerArr = response[i].members[j].powers;
          var power = $("<p>").text(powerArr[powerArr.length -1]);
          ...
          9.
				  ...
				  */
          hero.append(imgWrap, name, power, hero);
