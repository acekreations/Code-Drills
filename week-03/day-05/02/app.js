$(document).ready(function() {
    ...
    7.
		...
		*/
		var col2 = $("<div>").addClass("col-xs-6 col-sm-6 col-md-12 col-lg-6");
		/*
    ...
    /*
		...
		*/
		var col3 = $("<div>").addClass("col-xs-6 col-sm-12 col-lg-6");
		/*
		...
		*/
		var high = $("<p>").html("High tempature: " + highTemp + "&#8457;");
		/*
			append `high` to `col3`
		*/
		col3.append(high);
		...
		*/
		var low = $("<p>").html("Low tempature: " + lowTemp + "&#8457;");
		/*
			append `low` to `col4`
		*/
		col4.append(low);
