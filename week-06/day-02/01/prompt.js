...
// ====================== STEP 4 ======================
//CREATE 6 WEAPONS
var bearHands = new Weapon("Bear Hands", 1, [5, 5], 95, 90, 100000000000);
...
// ====================== STEP 5 ======================
//CREATE 5 ZOMBIES
var zombie1 = new Zombie("Zombie 1", 100, [1, 6], 18);
var zombie2 = new Zombie("Zombie 2", 90, [1, 6], 18);
var zombie3 = new Zombie("Zombie 3", 85, [2, 4], 20);
var zombie4 = new Zombie("Zombie 4", 80, [2, 5], 22);
var zombie5 = new Zombie("Zombie 5", 60, [7, 10], 10);
...
var guns = ["Bear hands", "Machete", "Shotgun", "Pistol", "Machine Gun", "Sniper", "View Weapon Stats"]
...
function Game() {
  ...
  this.playRound = function () {
    ...
    for (var i = 0; i < zombieFighters.length; i++) {
      console.log(zobieFighters.name + " health is " + zombieFighters[i].health);
    }
