...
function Human(name, birthday){
  this.name = name;
  this.age = 0;
  this.birthday = function(birthday){
    this.age += birthday;
...
/*
  Answer here:
  Because we changed the Human constructor opposed to just the instance of the human object.
  Then we used "this" to call the properties of the instance rather than a hard coded value.
